...
<head>
    ...
    <title>Agregar Usuario - Auren</title>
...
<body>
    ...
    <div class="header-content">
        <div class="container">
            <h2 style="padding-top: 30px;">Agregar Nuevo Usuario</h2>
            <p>Completa los detalles para añadir un nuevo usuario a la base de datos.</p>
        </div>
    </div>

    <div class="container">
        <div class="form-section">
            <h2 class="mb-4 text-center">Formulario de Registro de Usuario</h2>
            ...
            <form action="<?= base_url('usuario_controller/guardar') ?>" method="post">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <button type="submit" class="btn btn-submit"><i class="bi bi-person-plus"></i> Registrar Usuario</button>
                    <a href="<?= base_url('usuario_controller') ?>" class="btn btn-back"><i class="bi bi-arrow-left-circle"></i> Volver</a>
                </div>
            </form>
        </div>
        <div class="text-start mt-4">
                <a href="<?= base_url('/usuario_controller') ?>" class="btn btn-back">
