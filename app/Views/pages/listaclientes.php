                        ...
                        <?php if (!empty($usuarios) && is_array($usuarios)): ?>
                            <?php foreach ($usuarios as $usuario): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('usuario_controller/editar/' . $usuario['id']) ?>" class="btn-action"><i class="bi bi-pencil-square"></i> Editar</a>
                                        <a href="<?= base_url('usuario_controller/eliminar/' . $usuario['id']) ?>" class="btn-action text-danger" onclick="return confirm('¿Estás seguro de que quieres eliminar este usuario?');"><i class="bi bi-trash"></i> Eliminar</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
