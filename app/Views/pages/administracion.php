...
<body>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card admin-card">
                    <div class="card-body">
                        ...
                        <a href="#productos" class="btn btn-admin">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card admin-card">
                    <div class="card-body">
                        ...
                        <a href="#clientes" class="btn btn-admin">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card admin-card">
                    <div class="card-body">
                        ...
                        <a href="#consultas" class="btn btn-admin">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3 mb-2">
                                <a href="#agregar-producto" class="btn btn-outline-light w-100">
                                    <i class="bi bi-plus-circle"></i> Agregar Producto
                                </a>
                            </div>
                            <div class="col-md-3 mb-2">
                                <a href="#agregar-cliente" class="btn btn-outline-light w-100">
                                    <i class="bi bi-person-plus"></i> Agregar Cliente
                                </a>
                            </div>
                            <div class="col-md-3 mb-2">
                                <a href="#inventario" class="btn btn-outline-light w-100">
                                    <i class="bi bi-eye"></i> Ver Inventario
                                </a>
                            </div>
                            <div class="col-md-3 mb-2">
                                <a href="#sitio-web" class="btn btn-outline-light w-100">
    ...
    <script>
        // Función para actualizar estadísticas (puedes conectarla con tu backend)
        function actualizarEstadisticas() {
            // Aquí puedes hacer llamadas AJAX para obtener los datos reales
            // Por ahora, valores de ejemplo
            document.getElementById('totalProductos').textContent = '23';
            document.getElementById('totalClientes').textContent = '15';
            document.getElementById('totalConsultas').textContent = '8';
        }
